            ...
            while (individuals.Count > 0) {
                ...
                if (rng.NextDouble() < 0.6) {
                    nextGenerationCandidates.Add(
                        individual1.Crossover(individual2, point).Mutate(1.0d/individual1.Genotype.Length, rng));
                    nextGenerationCandidates.Add(
                        individual2.Crossover(individual1, point).Mutate(1.0d/individual2.Genotype.Length, rng));
                }
                else {
                    nextGenerationCandidates.Add(
